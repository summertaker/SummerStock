...
public class CurrentAdapter extends BaseDataAdapter {
    ...
    public CurrentAdapter(Context context, ArrayList<Item> dataList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.current_row, null);
        ...
        // 예측일
        String indt = data.getPdt();
        holder.tvPdt.setText(indt);
